...
export declare function _typed<T>(isValid: (value: any) => value is T, invalidValueDefault: T): (cmd: import("expangine-runtime").Command<Record<string, any>, any>, context: Record<string, any>, invalidValue?: T) => T;
export declare function _typedDynamic<T>(isValid: (value: any) => value is T, invalidValueDefault: () => T): (cmd: import("expangine-runtime").Command<Record<string, any>, any>, context: Record<string, any>, invalidValue?: () => T) => T;
export declare const _boolMaybe: (cmd: import("expangine-runtime").Command<Record<string, any>, any>, context: Record<string, any>, invalidValue?: boolean) => boolean;
export declare const _number: (cmd: import("expangine-runtime").Command<Record<string, any>, any>, context: Record<string, any>, invalidValue?: number) => number;
export declare const _numberMaybe: (cmd: import("expangine-runtime").Command<Record<string, any>, any>, context: Record<string, any>, invalidValue?: number) => number;
export declare const _text: (cmd: import("expangine-runtime").Command<Record<string, any>, any>, context: Record<string, any>, invalidValue?: string) => string;
export declare const _textMaybe: (cmd: import("expangine-runtime").Command<Record<string, any>, any>, context: Record<string, any>, invalidValue?: string) => string;
export declare const _list: (cmd: import("expangine-runtime").Command<Record<string, any>, any>, context: Record<string, any>, invalidValue?: () => any[]) => any[];
export declare const _listMaybe: (cmd: import("expangine-runtime").Command<Record<string, any>, any>, context: Record<string, any>, invalidValue?: any[]) => any[];
export declare const _map: (cmd: import("expangine-runtime").Command<Record<string, any>, any>, context: Record<string, any>, invalidValue?: () => Map<any, any>) => Map<any, any>;
